...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { f_name: @name.f_name, l_name: @name.l_name, notes: @name.notes, user_id: @name.user_id }
    end
  ...
  test "should update name" do
    patch :update, id: @name, name: { f_name: @name.f_name, l_name: @name.l_name, notes: @name.notes, user_id: @name.user_id }
    assert_redirected_to name_path(assigns(:name))
  end
